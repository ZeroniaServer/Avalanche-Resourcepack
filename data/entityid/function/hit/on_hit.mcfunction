...
#> Icicle in general
execute if entity @s[tag=!hitbox,tag=!GiftboxInteraction,tag=!Knockout,tag=!IFrame] as @a[tag=hitter,limit=1,advancements={entityid:hit={icicle=true}}] run function powerups:icicle/damage
