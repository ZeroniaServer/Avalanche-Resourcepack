...
execute unless score $gamestate CmdData matches 4 run title @s[scores={HitmarkerType=0,HitmarkerTimer=2}] title {"text":"\uE01B"}
execute unless score $gamestate CmdData matches 4 run title @s[scores={HitmarkerType=0,HitmarkerTimer=3}] title {"text":"\uE01C"}
execute unless score $gamestate CmdData matches 4 run title @s[scores={HitmarkerType=0,HitmarkerTimer=4}] title {"text":"\uE01D"}
