...
execute if score $prepticks CmdData matches ..0 run team modify Lobby nametagVisibility never
execute if score $prepticks CmdData matches ..0 run scoreboard objectives setdisplay below_name fireworkCount
execute if score $prepticks CmdData matches ..0 run scoreboard players set $gamestate CmdData 3