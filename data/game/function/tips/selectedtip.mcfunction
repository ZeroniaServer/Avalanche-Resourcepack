...
execute as @a[tag=!hideTips,scores={GamesPlayed=1}] run tellraw @s ["",{"translate":"tip.game","color":"dark_aqua","with":[{"score":{"name":"@s","objective":"GamesPlayed"},"color":"aqua","bold":true}]}]
