...
tellraw @a ["",{"translate":"tip.click","color":"dark_aqua","with":[{"translate":"tip.here","color":"green","clickEvent":{"action":"run_command","value":"/trigger toggleTips"},"hoverEvent":{"action":"show_text","contents":[{"translate":"tip.here.hover"}]}}]}]
