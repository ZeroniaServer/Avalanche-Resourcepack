...
execute if entity @s[tag=Tip22] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.22","color":"gray"}]
execute if entity @s[tag=Tip23] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.23","color":"gray"}]
execute if entity @s[tag=Tip24] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.24","color":"gray"}]
execute if entity @s[tag=Tip25] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.25","color":"gray"}]
execute if entity @s[tag=Tip26] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.26","color":"gray"}]
execute if entity @s[tag=Tip27] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.27","color":"gray"}]
execute if entity @s[tag=Tip28] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.28","color":"gray"}]
execute if entity @s[tag=Tip29] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.29","color":"gray"}]
execute if entity @s[tag=Tip30] run tellraw @a[tag=!hideTips] ["",{"text":"<","color":"aqua"},{"translate":"tip.tip","bold":true,"color":"dark_aqua"},{"text":"> ","color":"aqua"},{"translate":"tip.30","color":"gray"}]

tellraw @a[tag=!hideTips] ["",{"translate":"tip.click","color":"dark_aqua","with":[{"translate":"tip.here","color":"green","clickEvent":{"action":"run_command","value":"/trigger toggleTips"},"hoverEvent":{"action":"show_text","contents":[{"translate":"tip.here.hover"}]}}]}]

scoreboard players set $Tip CmdData 0

execute unless entity @e[type=marker,tag=TipSet] run function game:tips/newset
kill @s