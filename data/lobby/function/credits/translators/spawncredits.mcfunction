...
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:'[{"text":"?"}]',alignment:"center"}
