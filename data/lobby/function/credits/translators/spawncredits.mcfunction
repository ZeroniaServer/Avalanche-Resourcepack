...
#> Page 1
#ZeroIceBear - Chinese
execute if score $TranslatorPage CmdData matches 1 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 1 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"ZeroIceBear",color:"#FFAA00"}],alignment:"center"}
execute if score $TranslatorPage CmdData matches 1 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Flag"],billboard:"fixed",background:0,transformation:{translation:[0f,0f,0f],scale:[0.0f,0.0f,0.0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{translate:":flag_cn:",color:"white"}],alignment:"center"}
#Shirowh_ - Spanish
execute if score $TranslatorPage CmdData matches 1 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 1 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Shirowh_",color:"#ffff00"}],alignment:"center"}
...
#Armero - Spanish
execute if score $TranslatorPage CmdData matches 1 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 1 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Armero",color:"gold"}],alignment:"center"}
...
execute if score $TranslatorPage CmdData matches 2 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Ostensvig",color:"#c0c0c0"}],alignment:"center"}
...
#Stuffy - Pirate Speak
execute if score $TranslatorPage CmdData matches 2 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 2 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Stuffy",color:"aqua"}],alignment:"center"}
...
execute if score $TranslatorPage CmdData matches 3 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Evtema3",color:"red"}],alignment:"center"}
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit1","Flag"],billboard:"fixed",background:0,transformation:{translation:[0f,0f,0f],scale:[0.0f,0.0f,0.0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{translate:":flag_au:",color:"white"}],alignment:"center"}
#Yatloaf - German
execute if score $TranslatorPage CmdData matches 3 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
execute if score $TranslatorPage CmdData matches 3 run item replace entity @e[type=item_display,tag=Credit2,tag=Skull,tag=!Old,limit=1] contents with player_head[profile={id:[I;1356720797,-1795994109,-1552605678,1039199064]}]
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit2","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Yatloaf",color:"#FF7FBF"}],alignment:"center"}
...
#? - ?
execute if score $TranslatorPage CmdData matches 3 run summon item_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Skull"],start_interpolation:0,interpolation_duration:0,transformation:{scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},item_display:"fixed"}
...
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"?"}],alignment:"center"}
