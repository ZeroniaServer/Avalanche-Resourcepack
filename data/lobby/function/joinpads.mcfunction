...
execute as @a[tag=JoinGreen] if score $gamestate CmdData matches 2..3 run tag @s remove SilentRespawn
...
execute as @a[tag=JoinRed] if score $gamestate CmdData matches 2..3 run tag @s remove SilentRespawn
