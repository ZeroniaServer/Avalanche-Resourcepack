...
execute if score $gamestate CmdData matches 0..3 run tellraw @s ["",{translate:"%1$s",with:[{nbt:"ResourcePack",storage:"avalanche:messages",interpret:true},{translate:"ver1.0.3","fallback":"%1$s",with:[{nbt:"OutdatedPack",storage:"avalanche:messages",interpret:true},{nbt:"ReadyToPlay",storage:"avalanche:messages",interpret:true}]}]}]
execute unless score $gamestate CmdData matches 0.. run tellraw @s[tag=!gotTheMemo] ["",{translate:"%1$s",with:[{nbt:"ResourcePack",storage:"avalanche:messages",interpret:true},{translate:"ver1.0.3","fallback":"%1$s",with:[{nbt:"OutdatedPack",storage:"avalanche:messages",interpret:true},{nbt:"SettingsBox",storage:"avalanche:messages",interpret:true,click_event:{action:"run_command",command:"/trigger settings"}}]}]}]
