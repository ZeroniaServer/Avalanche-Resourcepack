...
summon minecraft:armor_stand -58.7 53.3 -73.2 {Invulnerable:true,NoBasePlate:true,NoGravity:true,ShowArms:true,Rotation:[335f, 0f],Pose:{Body:[16f,0f,0f],Head:[34f,12f,0f],LeftLeg:[285f,328f,0f],RightLeg:[305f,10f,0f],LeftArm:[344f,0f,350f],RightArm:[346f,0f,12f]},equipment:{feet:{id:"diamond_boots"},legs:{id:"golden_leggings"},chest:{id:"diamond_chestplate"},head:{id:"player_head",components:{"minecraft:profile":{name:"MHF_Question"}}}},Tags:["parkour_display"],DisabledSlots:4144959}
