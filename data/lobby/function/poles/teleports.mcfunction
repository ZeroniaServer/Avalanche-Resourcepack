...
execute as @a[tag=WarpGreen] at @s run particle flash{color:0xFFFFFF} -84 55 -150 0 0 0 0 2 force @s
...
execute as @a[tag=WarpRed] at @s run particle flash{color:0xFFFFFF} -39 51 -150 0 0 0 0 2 force @s
...
execute as @a[tag=WarpLobby,tag=!LeaveWarp] at @s run particle flash{color:0xFFFFFF} -63 51 -124 0 0 0 0 2 force @s
execute as @a[tag=WarpLobby,tag=LeaveWarp] at @s run particle flash{color:0xFFFFFF} ^ ^1 ^1 0 0 0 0 2 force @s
...
execute as @a[tag=WarpSettings] at @s run particle flash{color:0xFFFFFF} -59 52 -90 0 0 0 0 2 force @s
