...
title @a[tag=!inParkour,team=!Spectator] actionbar ["",{"translate":"lobby.marked_ready","color":"aqua","with":[{"selector":"@s","bold":true},{"translate":"lobby.marked_ready.green","color":"green","bold":true},{"translate":"lobby.marked_ready.ready","color":"#03DE00","bold":true,"underlined":true}]}]
