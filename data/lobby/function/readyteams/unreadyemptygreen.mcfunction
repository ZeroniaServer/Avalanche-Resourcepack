title @a actionbar ["",{"translate":"lobby.marked_ready.has_been","color":"aqua","with":[{"translate":"lobby.marked_ready.green","color":"green","bold":true},{"translate":"lobby.marked_ready.not","color":"#D20000","bold":true,"underlined":true}]}]
