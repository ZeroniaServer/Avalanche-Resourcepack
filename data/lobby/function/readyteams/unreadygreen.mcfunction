...
title @a[team=!Spectator] actionbar ["",{"translate":"lobby.marked_ready","color":"aqua","with":[{"selector":"@s","bold":true},{"translate":"lobby.marked_ready.green","color":"green","bold":true},{"translate":"lobby.marked_ready.not","color":"#D20000","bold":true,"underlined":true}]}]
