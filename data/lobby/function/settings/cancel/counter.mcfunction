...
data modify block -56 53 -90 front_text.messages[2] set value '{"translate":"customizer.cancel.available_in","color":"white","with":[{"color":"#ff8585","score":{"name":"$mcancelcount","objective":"CmdData"}}]}'
