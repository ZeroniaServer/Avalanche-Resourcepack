...
execute if score $GreenRespawn CmdData matches 2..10 positioned -114 45 -210 run playsound playerrespawn master @a[distance=..5] ~ ~ ~ 1 1
execute if score $GreenRespawn CmdData matches 2..10 positioned -114 45 -210 run playsound playerrespawn master @a[distance=..5] ~ ~ ~ 1 0.6
...
execute if score $RedRespawn CmdData matches 2..10 positioned -12 45 -232 run playsound playerrespawn master @a[distance=..5] ~ ~ ~ 1 1
execute if score $RedRespawn CmdData matches 2..10 positioned -12 45 -232 run playsound playerrespawn master @a[distance=..5] ~ ~ ~ 1 0.6
