execute if score @s knocktime matches 2.. run return fail

execute store result storage game:data player_fireworks int 1 run scoreboard players get @s fireworkCount
execute if score @s fireworkCount matches ..0 run data modify storage game:data color set value 'white'
