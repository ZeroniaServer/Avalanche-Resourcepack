...
execute as @e[type=item_display,tag=CampfireEntity,tag=Flame,tag=!reignite,scores={CmdData=18}] at @s run playsound item.flintandsteel.use master @a ~ ~ ~ 0.6 0.7
execute as @e[type=item_display,tag=CampfireEntity,tag=Flame,tag=reignite,scores={CmdData=18}] at @s run playsound entity.blaze.shoot master @a ~ ~ ~ 0.6 0.6
...
execute as @e[type=item_display,tag=CampfireEntity,tag=Flame,tag=!reignite,scores={CmdData=22}] at @s run playsound entity.blaze.shoot master @a ~ ~ ~ 0.6 0.6
