...
execute if entity @s[tag=Green,scores={healticks=6..12}] run scoreboard players add @a[team=Green,tag=!Knockout,scores={playerHP=1..19},distance=..3.5] playerHP 1
...
execute if entity @s[tag=Red,scores={healticks=6..12}] run scoreboard players add @a[team=Red,tag=!Knockout,scores={playerHP=1..19},distance=..3.5] playerHP 1
