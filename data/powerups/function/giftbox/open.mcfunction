playsound block.wool.break master @a ~ ~ ~ 0.4 1.6
playsound block.wool.break master @a ~ ~ ~ 0.4 0.6
playsound minecraft:entity.chicken.egg master @a ~ ~ ~ 1 0.9
playsound entity.experience_orb.pickup master @a ~ ~ ~ 0.2 1.2

particle item{item:{id:"minecraft:diamond_hoe",components:{custom_model_data:25}}} ~ ~0.2 ~ 0.1 0.1 0.1 0.03 30 force
