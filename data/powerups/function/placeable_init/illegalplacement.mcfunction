...
execute if entity @e[type=item_display,tag=Snowman,tag=!Dying,distance=..0.5] run return run tag @s add illegal
...
execute unless predicate game:in_arena run return run tag @s add illegal
