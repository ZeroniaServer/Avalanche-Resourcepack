...
execute if entity @s[team=Green] as @e[type=item] if items entity @s contents snowball[custom_data~{Dropped:1b}] run data merge entity @s {Tags:["RocketItemRed","RocketItem"],PickupDelay:100000,Age:-32768}
execute if entity @s[team=Red] as @e[type=item] if items entity @s contents snowball[custom_data~{Dropped:1b}] run data merge entity @s {Tags:["RocketItemGreen","RocketItem"],PickupDelay:100000,Age:-32768}
