...
execute if predicate powerups:sleigh_void on passengers on passengers at @s[type=player] run particle block{block_state:"spruce_planks"} ~ ~5 ~ 0.5 0.5 0.5 0.1 100 force
