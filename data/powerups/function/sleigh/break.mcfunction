...
execute if predicate game:void at @s run particle block{block_state:"spruce_planks"} ~ ~ ~ 0.5 0.5 0.5 0.1 100 force
execute unless predicate game:void if entity @s[tag=Occupied] on passengers on passengers run tag @s[type=player] add SleighDismounted
execute unless predicate game:void if entity @s[tag=Occupied] on passengers on passengers at @s[type=player] run particle block{block_state:"spruce_planks"} ~ ~5 ~ 0.5 0.5 0.5 0.1 100 force
execute unless predicate game:void unless entity @s[tag=Occupied] at @s run particle block{block_state:"spruce_planks"} ~ ~ ~ 0.5 0.5 0.5 0.1 100 force
