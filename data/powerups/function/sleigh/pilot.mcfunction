...
execute at @s[tag=!SleighOffGround,predicate=!game:in_air] on passengers on passengers if predicate wasd:jump on vehicle on vehicle run tag @s add SleighJumpBig
