...
execute unless score $gamestate CmdData matches 4 at @s[tag=Red,scores={CmdData=1..260}] positioned ~-4.5 ~-5.5 ~-4.5 run tag @a[team=Green,tag=!Knockout,tag=!IFrame,dx=8.5,dy=8.5,dz=8.5] add SnowMark
execute unless score $gamestate CmdData matches 4 at @s[tag=Green,scores={CmdData=1..260}] positioned ~-4.5 ~-5.5 ~-4.5 run tag @a[team=Red,tag=!Knockout,tag=!IFrame,dx=8.5,dy=8.5,dz=8.5] add SnowMark
execute unless score $gamestate CmdData matches 4 at @s[tag=Red,scores={CmdData=1..260}] positioned ~-4.5 ~-5.5 ~-4.5 run scoreboard players set @a[team=Green,tag=!Knockout,dx=8.5,dy=8.5,dz=8.5,scores={snowmark=2..}] snowmark 2
execute unless score $gamestate CmdData matches 4 at @s[tag=Green,scores={CmdData=1..260}] positioned ~-4.5 ~-5.5 ~-4.5 run scoreboard players set @a[team=Red,tag=!Knockout,dx=8.5,dy=8.5,dz=8.5,scores={snowmark=2..}] snowmark 2
...
tag @s add self
execute as @a[tag=InEnemyCloud,scores={blizzardtime=5},tag=!IFrame,tag=!Knockout] if score @s playerDamage >= @s playerHP run function powerups:snowglobe/knockout
tag @s remove self
execute as @a[tag=InEnemyCloud,tag=!Knockout,scores={blizzardtime=5},tag=!IFrame] run damage @s 1 starve
execute as @a[tag=InEnemyCloud,scores={blizzardtime=10..}] run scoreboard players reset @s blizzardtime

execute unless score $gamestate CmdData matches 4 run effect give @a[tag=InEnemyCloud,tag=!Knockout] slowness 1 3 true
