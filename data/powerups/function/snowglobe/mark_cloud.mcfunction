...
data merge entity @s[tag=DespawnCloud,scores={snowmark=1}] {start_interpolation:0,interpolation_duration:5,transformation:{scale:[0.0f,0.0f,0.0f],translation:[0.0f,1.0f,0.0f]}}
