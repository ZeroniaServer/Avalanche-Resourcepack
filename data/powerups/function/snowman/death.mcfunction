...
execute at @s[tag=Dying,scores={CmdData=50}] run playsound block.snow.break master @a ~ ~ ~ 1 0
execute at @s[tag=Dying,scores={CmdData=50}] run playsound block.snow.break master @a ~ ~ ~ 1 0.7
execute at @s[tag=Dying,scores={CmdData=50}] run playsound block.snow.break master @a ~ ~ ~ 1 1.2
execute at @s[tag=Dying,scores={CmdData=50}] run playsound block.powder_snow.place master @a ~ ~ ~ 1 2
execute at @s[tag=Dying,scores={CmdData=50}] run playsound minecraft:entity.snow_golem.hurt master @a ~ ~ ~ 1 0
execute at @s[tag=Dying,scores={CmdData=50..55}] run playsound minecraft:block.powder_snow.break master @a ~ ~ ~ 1 0
execute at @s[tag=Dying,scores={CmdData=50..58}] run playsound minecraft:block.powder_snow.break master @a ~ ~ ~ 1 2
execute at @s[tag=Dying,scores={CmdData=55}] run playsound minecraft:block.snow.fall master @a ~ ~ ~ 1 1
execute at @s[tag=Dying,scores={CmdData=57}] run playsound minecraft:block.snow.fall master @a ~ ~ ~ 1 0.7
execute at @s[tag=Dying,scores={CmdData=59}] run playsound minecraft:block.snow.fall master @a ~ ~ ~ 1 1.3

execute at @s[tag=Dying,scores={CmdData=61}] run playsound minecraft:block.wool.fall master @a ~ ~ ~ 1 1.2
execute at @s[tag=Dying,scores={CmdData=85}] run playsound block.powder_snow.fall master @a ~ ~ ~ 1 0
...
execute at @s[tag=Dying,scores={CmdData=219}] run playsound block.wool.break master @a ~ ~ ~ 0.4 1.2
