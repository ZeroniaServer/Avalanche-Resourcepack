execute at @s[scores={CmdData=1}] run playsound snowmanspawn1 master @a ~ ~ ~ 1 0
execute at @s[scores={CmdData=1}] run playsound snowmanspawn1 master @a ~ ~ ~ 1 1
execute at @s[scores={CmdData=1}] run playsound snowmanspawn1 master @a ~ ~ ~ 1 2
execute at @s[scores={CmdData=1}] run particle block{block_state:snow_block} ~ ~ ~ 0.2 0.2 0.2 0.1 30 force

execute at @s[scores={CmdData=15}] run playsound snowmanspawn2 master @a ~ ~ ~ 1 1.2
...
execute at @s[scores={CmdData=18}] run playsound snowmanspawn2 master @a ~ ~ ~ 1 0.8
execute at @s[scores={CmdData=20}] run playsound snowmansnow master @a ~ ~ ~ 1 1.2
execute at @s[scores={CmdData=22}] run playsound snowmansnow master @a ~ ~ ~ 1 1.4
