...
execute if predicate wasd:forward unless predicate wasd:backward if predicate wasd:left unless predicate wasd:right rotated ~ 0 positioned 0. 0 0. positioned ^0.0175 ^ ^0.0175 rotated ~-45 ~ summon marker run function wasd:move
execute if predicate wasd:forward unless predicate wasd:backward unless predicate wasd:left if predicate wasd:right rotated ~ 0 positioned 0. 0 0. positioned ^-0.0175 ^ ^0.0175 rotated ~45 ~ summon marker run function wasd:move
...
execute unless predicate wasd:forward unless predicate wasd:backward if predicate wasd:left unless predicate wasd:right rotated ~ 0 positioned 0. 0 0. positioned ^0.0175 ^ ^ rotated ~-90 ~ summon marker run function wasd:move
execute unless predicate wasd:forward unless predicate wasd:backward unless predicate wasd:left if predicate wasd:right rotated ~ 0 positioned 0. 0 0. positioned ^-0.0175 ^ ^ rotated ~90 ~ summon marker run function wasd:move
